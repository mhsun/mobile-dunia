<?php include_once('header.php'); ?>
		...
		<div class="content">
			<div class="product" id="home">
				...
				<div class="search">
					<form>
						<select name="brand" id="brand" onchange="showDealerHint(this.value)" style="width: 30%;">
						...
						<select name="brand" id="brn" onchange="showDealerBrand(this.value)" style="display: none;">
						...
						<select class="sel" id="price" onchange="showDealerPrice(this.value)" style="display: none;">
						...
						<select id="area" onchange="showDealerArea(this.value)" style="display: none;">
				...
				<div class="product_image" id="txtHint">
					<?php while ($result = mysqli_fetch_assoc($res)) {?>
						<div class="item">
						    <a href="single_dealer.php?v=<?= $result['p_id']; ?>"><img src="admin/<?= $result['p_image']; ?>"/>
