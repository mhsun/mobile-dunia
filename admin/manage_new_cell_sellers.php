<?php include_once('admin_sidebar.php'); ?>
		<div class="content">
			<div class="form_title">
				<h2>Manage New Cell Sellers</h2>
			</div>
			<div class="form_search">
				<form action="user_search" method="GET">
					<input type="text" name="search" placeholder="Type Here To Search">
					<input type="hidden" name="user" value="new-cell-seller">
			...
			<div class="data">
				<table>
					...
					<?php
						$query = "SELECT * FROM md_user WHERE user_type='new-cell-seller'";
						$res = selectAll($query);
					...
					<tr>
						...
						<td style="text-align: center;">
							...
							<a href="delete_new_cell_seller.php?d=<?= $result['user_id']; ?>" class="dlt" onclick="return confirm('Are you sure to DELETE?')">| Delete</a>
							<?php } ?>
						</td>
					</tr>
					<?php } ?>
